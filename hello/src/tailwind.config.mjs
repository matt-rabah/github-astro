  ...
  theme: {
    extend: {
      fontSize: {
        ...
        xl: [
          "1.25rem",
          { lineHeight: "1.5", letterSpacing: "0.03em", fontWeight: "600" },
        ],
        "2xl": [
          "1.5rem",
          { lineHeight: "1.4", letterSpacing: "0.03em", fontWeight: "700" },
        ],
        "3xl": [
          "1.875rem",
          { lineHeight: "1.3", letterSpacing: "0.035em", fontWeight: "700" },
        ],
        "4xl": [
          "2.25rem",
        ...
        "6xl": [
          "3.75rem",
          { lineHeight: "1.1", letterSpacing: "0.05em", fontWeight: "900" },
        ],
        "7xl": [
          "4.5rem",
          { lineHeight: "1.1", letterSpacing: "0.05em", fontWeight: "900" },
