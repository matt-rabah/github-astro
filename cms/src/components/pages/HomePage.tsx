            ...
            <div className="bg-primary text-primary-foreground flex flex-col justify-center px-8 md:px-16 lg:px-24 py-20 lg:py-0 relative">
              ...
              <Reveal delay={100}>
                <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl leading-[1.1] mb-10">
                  Our journey begins where conventionality ends. We have never
                  been accustomed to the word "impossible".
                </h1>
              </Reveal>
              ...
              <Reveal delay={200}>
                <div className="max-w-xl">
                  <p className="font-paragraph text-lg md:text-xl leading-relaxed opacity-90 mb-12">
                    At Finnegan & Fahr we are exceptionally skilled at our
                    craft. Challenges are our guiding stars, and innovation is
                    our trusted compass.
                  </p>
          ...
          <div className="flex whitespace-nowrap animate-marquee">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="flex items-center mx-8 opacity-60">
                <span className="font-heading text-2xl md:text-3xl text-secondary-foreground mx-4">
                  STRATEGIC DESIGN
                </span>
              ...
              <div className="lg:col-span-5 flex flex-col justify-end">
                <Reveal delay={100}>
                  <p className="font-paragraph text-lg text-foreground/80 leading-relaxed mb-8 max-w-md ml-auto">
                    Our curated selection represents the pinnacle of design
                    thinking. Each item is a testament to form following
                    function in the most elegant way possible.
                  </p>
            ...
            {featuredItems.length > 0 ? (
                    ...
                    <Link to={`/catalog/${item._id}`} className="block h-full">
                      <div className="relative aspect-[3/4] overflow-hidden bg-white mb-6">
                        ...
                        <Image
                          src={
                            item.mainImage ||
                            "https://static.wixstatic.com/media/48031e_444a57495795462ba9ba46fa5902148c~mv2.png?originWidth=576&originHeight=768"
                          }
              ...
              <div className="py-20 text-center border border-dashed border-foreground/20 rounded-lg">
                <p className="font-paragraph text-foreground/60">
                  Catalog items are currently being curated.
                </p>
              </div>
            )}
          </div>
              ...
              <div className="lg:col-span-4">
                <StickyHeader title="Core Capabilities" subtitle="Expertise">
                  <p className="font-paragraph text-lg text-foreground/70 leading-relaxed mb-8">
                    We combine technical precision with creative intuition to
                    deliver spaces and objects that stand the test of time.
                  </p>
                  <Link
                    to="/about"
                    className="inline-flex items-center gap-2 font-medium text-primary hover:gap-4 transition-all"
                  >
        ...
        */}
        <section className="w-full h-[80vh] relative overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url('https://static.wixstatic.com/media/48031e_ea6a1185a1d040f4aadc6b243bb30462~mv2.png?originWidth=1920&originHeight=1024')",
            }}
          >
          ...
          <div className="relative z-20 h-full flex items-center justify-center text-center px-6">
            <div className="max-w-4xl">
              ...
              <p className="font-paragraph text-xl text-white/90 max-w-2xl mx-auto">
                We believe that good design is not just seen, but felt. It is an
