  ...
  theme: {
    extend: {
      fontSize: {
        ...
        "6xl": [
          "4.5rem",
          { lineHeight: "1.05", letterSpacing: "-0.05em", fontWeight: "900" },
        ],
        "7xl": [
          "5.5rem",
          { lineHeight: "1.05", letterSpacing: "-0.06em", fontWeight: "900" },
        ],
        "8xl": [
          "6.5rem",
        ...
        "9xl": [
          "8rem",
          { lineHeight: "1", letterSpacing: "-0.08em", fontWeight: "900" },
        ],
      },
      fontFamily: {
