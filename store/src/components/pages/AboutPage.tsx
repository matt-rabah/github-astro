  ...
  const values = [
    {
      title: "Quality First",
      description:
        "We source only the finest materials and partner with manufacturers who share our commitment to excellence.",
    },
    {
      title: "Sustainable Practices",
      description:
        "Environmental responsibility guides our decisions, from material selection to packaging and distribution.",
    },
    {
      title: "Customer Focus",
      description:
        "Your satisfaction drives everything we do. We stand behind every product with comprehensive support.",
    },
  ];
  ...
  const team = [
    {
      ...
      role: "Founder & CEO",
      image:
        "https://static.wixstatic.com/media/48031e_a6703183730342cebae0c35629a3e448~mv2.png?originWidth=384&originHeight=512",
    },
    {
      name: "James Rodriguez",
      role: "Head of Product",
      image:
        "https://static.wixstatic.com/media/48031e_c0b75e146c234f9d97c97a05ef7b1e34~mv2.png?originWidth=384&originHeight=512",
    },
    {
      name: "Emily Chen",
      role: "Design Director",
      image:
        "https://static.wixstatic.com/media/48031e_95d7fdf9620c4cd8980b7fe7df9f44fb~mv2.png?originWidth=384&originHeight=512",
    },
  ];
                ...
                seoData: {
                  tags: [
                    ...
                    },
                    {
                      ...
                      props: {
                        content:
                          "Founded on the belief that exceptional athletic performance begins with exceptional equipment. Learn about our mission, values, and team.",
                        name: "description",
                      },
                    },
                  ],
        ...
        <section className="w-full max-w-[100rem] mx-auto px-8 lg:px-16 py-24 lg:py-32">
          ...
          >
            ...
            <p className="font-paragraph text-xl lg:text-2xl italic text-secondary leading-relaxed">
              Founded on the belief that exceptional athletic performance begins
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="font-paragraph text-lg italic text-secondary mb-6 leading-relaxed">
                We exist to empower athletes at every level with gear that
                enhances performance, inspires confidence, and stands the test
                of time. Our commitment extends beyond products to building a
                community united by passion for sport and dedication to
                excellence.
              </p>
              <p className="font-paragraph text-lg italic text-secondary leading-relaxed">
                Through rigorous testing, sustainable practices, and continuous
                innovation, we create sporting goods that meet the demands of
                modern athletes while respecting our planet's future.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="w-full max-w-[100rem] mx-auto px-8 lg:px-16 py-16 lg:py-24">
          ...
          >
            ...
            <p className="font-paragraph text-lg lg:text-xl italic max-w-3xl mx-auto opacity-90 leading-relaxed">
              Every product undergoes rigorous testing by professional athletes
              and everyday enthusiasts alike. We don't release anything until it
              meets our exacting standards for quality, durability, and
              performance.
            </p>
          </motion.div>
        </section>
