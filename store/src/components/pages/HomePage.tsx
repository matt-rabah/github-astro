...
const VALUES_DATA: ValueItem[] = [
  {
    ...
    description:
      "Carefully selected materials engineered for peak performance and lasting durability.",
    image:
      "https://static.wixstatic.com/media/48031e_523baa4407a4452b93491f6c11d63839~mv2.png?originWidth=576&originHeight=704",
  },
  {
    title: "Sustainable Design",
    description:
      "Thoughtfully crafted with eco-conscious materials and responsible manufacturing practices.",
    image:
      "https://static.wixstatic.com/media/48031e_8f57d2ffa90749d0b9ed11f4bf4b763f~mv2.png?originWidth=576&originHeight=704",
  },
  {
    title: "Performance Driven",
    description:
      "Engineered to enhance your athletic experience with innovative technology and design.",
    image:
      "https://static.wixstatic.com/media/48031e_cbb8604f99a44514891f607bdb5358c4~mv2.png?originWidth=576&originHeight=704",
  },
];
    ...
    <div className="w-full overflow-hidden bg-primary py-4 border-y border-primary">
      ...
      >
        {[...Array(8)].map((_, i) => (
          <span
            key={i}
            className="text-primary-foreground font-heading text-lg uppercase tracking-widest flex items-center gap-8"
          >
                  ...
                  tags: [
                    {
                      type: "title",
                      children:
                        "Gear Built For Champions - Premium Sporting Goods",
                    },
                    {
                      type: "meta",
                      props: {
              ...
              <Reveal delay={0.4} className="mt-auto">
                <div className="flex flex-col gap-6">
                  <p className="font-paragraph text-xl lg:text-2xl italic text-secondary max-w-md leading-relaxed">
                    Discover premium sporting goods designed to elevate your
                    performance and inspire your journey to excellence.
                  </p>
                  <Link
                    to="/store"
                    className="group inline-flex items-center gap-2 text-lg font-heading uppercase tracking-wide border-b border-primary pb-1 w-fit hover:text-mutedgray hover:border-mutedgray transition-colors"
                  >
                    Explore Collection
            ...
            <div className="lg:col-span-7 h-full min-h-[50vh] lg:min-h-[80vh] relative">
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 bg-background/90 backdrop-blur-sm p-6 rounded-xl max-w-xs hidden md:block">
                  <p className="font-heading text-sm uppercase tracking-wider mb-1 text-mutedgray">
                    Featured
                  </p>
                  <p className="font-paragraph italic text-lg">
                    The new standard in athletic performance.
                  </p>
                </div>
              </motion.div>
            </div>
              ...
              <Reveal delay={0.2}>
                <div className="flex flex-col items-start md:items-end gap-4">
                  <p className="font-paragraph text-xl italic text-secondary max-w-md text-left md:text-right">
                    Explore our latest collection of premium sporting goods
                    designed for athletes who demand the best.
                  </p>
                  <Link to="/store">
                    <Button
                      variant="outline"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8 h-auto md:h-[80vh]">
              ...
              <div className="md:col-span-2 h-[60vh] md:h-full relative group overflow-hidden rounded-2xl">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-8 lg:p-12">
                  <h3 className="text-white font-heading text-3xl uppercase mb-2 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    The Pro Series
                  </h3>
                  <p className="text-white/90 font-paragraph italic text-lg translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-75">
              ...
              <div className="flex flex-col gap-4 lg:gap-8 h-full">
                ...
                <div className="flex-1 relative group overflow-hidden rounded-2xl bg-white">
                  ...
                  <div className="absolute bottom-6 left-6">
                    <span className="font-heading uppercase text-sm bg-primary text-primary-foreground px-3 py-1 rounded-full">
                      New
                    </span>
                  </div>
                </div>
              ...
              <div className="p-12 lg:p-24 flex flex-col justify-center relative z-10">
                <Reveal>
                  ...
                  <p className="font-paragraph text-lg lg:text-xl italic text-primary-foreground/80 mb-8 leading-relaxed max-w-md">
                    Every piece in our collection combines cutting-edge athletic
                    technology with timeless design principles. From
                    moisture-wicking fabrics to ergonomic accessories, we ensure
                    your gear works as hard as you do.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-6">
                    <Link to="/about">
                      <Button
                        size="lg"
                        className="bg-primary-foreground text-primary hover:bg-white w-full sm:w-auto font-heading uppercase tracking-wide"
                      >
                        Read Our Story
                      </Button>
                    </Link>
                    <Link to="/store">
                      <Button
                        size="lg"
                        variant="outline"
                        className="border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary w-full sm:w-auto font-heading uppercase tracking-wide"
                      >
                        Shop Collection
                      </Button>
                    </Link>
