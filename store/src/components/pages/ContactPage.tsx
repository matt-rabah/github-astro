                ...
                seoData: {
                  tags: [
                    ...
                    },
                    {
                      ...
                      props: {
                        content:
                          "We're here to help with any questions about our products or services. Contact us today.",
                        name: "description",
                      },
                    },
                  ],
              ...
              <div className="mt-12 p-8 bg-primary/5 border border-subtleborder rounded-2xl">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="font-paragraph text-base italic text-secondary">
                      Monday - Friday
                    </span>
                    <span className="font-paragraph text-base italic text-primary">
                      9:00 AM - 6:00 PM
                    </span>
                  </div>
                  <div className="flex justify-between">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      <Label
                        htmlFor="name"
                        className="font-heading text-sm uppercase tracking-wide text-primary mb-2 block"
                      >
                        Name *
                      </Label>
                      <Input
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="font-paragraph text-base italic text-secondary leading-relaxed">
                We offer free shipping on orders over $100. Standard delivery
            ...
            >
              ...
              <p className="font-paragraph text-base italic text-secondary leading-relaxed">
                30-day return policy on all items. Products must be unused with
            ...
            >
              ...
              <p className="font-paragraph text-base italic text-secondary leading-relaxed">
                Care instructions are included with each product. Most items are
                machine washable.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="font-paragraph text-base italic text-secondary leading-relaxed">
                All products come with a 1-year warranty against manufacturing
                defects.
              </p>
            </motion.div>
          </div>
